...
<html>
  ...
  <body>
    <div id="detail_top">
  		...
  		<strong>您现在所在的位置是：<span id="now_page">商品信息添加页面</span></strong>
  	</div>
  	<form action="goodsInfoServlet" method="post" enctype="multipart/form-data">
  	  <table id="goodAdd_table">
  	  	<input type="hidden" name="op" value="addgood" />
  		<tr>
  		...
  		<tr>
  			...
  			<td>
  				<input class="input_txt" type="text" name="goodName" placeholder="请输入商品名称" />
  			</td>
  		</tr>
  		<tr>
  			<td class="title_td">商品价格：</td>
  			<td>
  				<input class="input_txt" type="text" name="goodPrice" placeholder="请输入商品价格" />
  			</td>
  		</tr>
  		<tr>
  			<td class="title_td">商品折扣：</td>
  			<td>
  				<input class="input_txt" type="text" name="goodDiscount" placeholder="请输入商品折扣" />
  			</td>
  		</tr>
  		<tr>
  		...
  		<tr>
  			...
  			<td>
  				<textarea name="goodRemark" style="width: 400px;" placeholder="请输入商品备注"></textarea>
  			</td>
  		</tr>
  		<input type="hidden" name="id" value="" />
  		<tr>
  			<td colspan="2">
  				<input id="input_sub" type="submit" value="添加" />
  			</td>
  		</tr>
  	  </table>
  	</form>
